...
class InteraccionUsuario(models.Model):
    ...
    reporte = models.ForeignKey('reporte.ReporteColaborativo', on_delete=models.CASCADE)  # Asumiendo que tienes un modelo Reporte
...
"""
Contenido de web/models.py de rama mauricio4 antes del merge con GODinez
from django.db import models
from django.contrib.auth.models import User
