...
class ReporteColaborativoForm(forms.ModelForm):
    class Meta:
        ...
        exclude = ['usuario_reportador', 'fecha_creacion', 'fecha_actualizacion', 'votos_positivos', 'votos_negativos', 'usuarios_votantes', 'es_validado', 'estado_reporte','latitud','longitud']
        widgets = {
            ...
            'ubicacion': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Ej: Av. Venezuela, Arequipa', 'id':'id_ubicacion', 'name':'ubicacion'}),
