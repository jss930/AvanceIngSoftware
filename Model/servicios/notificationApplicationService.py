...
from Model.dominio.notificacion.notificacion import Notificacion, TipoNotificacion # type: ignore
...
class NotificationApplicationService:
    ...
    def enviar_notificacion_usuario(self, usuario_id, mensaje, tipo="general", titulo=None):
        ...
        try:
            ...
            # Enviar notificación externa si corresponde
            ...
            raise RuntimeError(f"Error accediendo a datos del usuario: {ae}")
        except Exception as e:
            raise RuntimeError(f"Error al enviar notificación: {e}")
    ...
    def obtener_notificaciones_no_leidas(self, usuario_id):
        ...
        try:
            ...
            raise RuntimeError(f"Error al obtener notificaciones: {e}")
    ...
    def marcar_como_leida(self, notificacion_id, usuario_id):
        ...
        try:
            ...
            if notificacion.usuario_id != usuario_id:
                raise PermissionError("No autorizado para modificar esta notificación")
    ...
    def obtener_estadisticas_notificaciones(self, usuario_id):
        ...
        try:
            ...
            raise RuntimeError(f"Error al obtener estadísticas: {e}")
    ...
    def _enviar_notificacion_externa(self, usuario, notificacion):
        ...
        try:
            ...
            # Solo loggear, no interrumpir el flujo principal
            print(f"[LOG] Error enviando notificación externa: {e}")
